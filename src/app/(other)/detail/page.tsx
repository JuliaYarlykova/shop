	...
	return (
		<main className='container min-h-screen w-screen'>
			...
			<section className='mx-[4px] mb-[90px] mt-[27px]'>
				<Title name='Описание' classNameProp='text-left mt-[10px] mb-[10px]' />
				<p className='pl-[40px] text-[20px] font-normal'>
					Электрическая варочная поверхность DEXP 4M2CTYL/B отличается от прочих
					подобных устройств компактными размерами и наличием 2 конфорок для
					приготовления пищи. Это позволяет разместить ее даже на самой
					маленькой кухне. Устройство устанавливается автономно от духового
					шкафа.
				</p>
			</section>
